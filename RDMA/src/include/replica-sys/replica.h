...
struct node_t* system_initialize(uint32_t* node_id,const char* config_path,const char* log_path,void(*user_cb)(db_key_type index,void* arg),int(*up_check)(void* arg),int(*up_get)(view_stamp clt_id, void* arg),void* db_ptr,void* arg);
