...
def processBench(config, bench):
    ...
    # testscript.write(
    #     'ssh ' + local_host + '  "' + 'sed -i \'/127.0.0.1/{n;s/.*/        port       = ' + port + ';/}\' $RDMA_ROOT/RDMA/target/nodes.local.cfg  "\n' +
    ...
    #
    # testscript.write(
    #     'ssh ' + local_host + '  "' + 'sed -i \'/check_output/c     check_output = ' + check_output + ';\' $RDMA_ROOT/RDMA/target/nodes.local.cfg  "\n' +
    ...
    # if server_count == 3:
    #     testscript.write('ssh -f ' + local_host + '  "' + hook_program.replace("myid",
    #                                                                            node_id_one) + server_program + ' ' + server_input + '"  \n' + 'sleep 2 \n' +
    #                      'ssh -f ' + remote_hostone + '  "' + hook_program.replace("myid",
    #                                                                                node_id_two) + server_program + ' ' + server_input + '" \n' + 'sleep 2 \n' +
    #                      'ssh -f ' + remote_hosttwo + '  "' + hook_program.replace("myid",
    #                                                                                node_id_thr) + server_program + ' ' + server_input + '" \n' + 'sleep 5 \n')
    # elif server_count == 1:
    #     testscript.write('ssh -f ' + local_host + '  "' + hook_program.replace("myid",
    #                                                                            node_id_one) + server_program + ' ' + server_input + '" \n' + 'sleep 5 \n')
    ...
    if testname == "clamav" or testname == "mediatomb":
        ...
        for client_input_part in client_input_list:
            testscript.write('timeout 240 ssh ' + test_host + '  "' + client_program + ' ' + client_input_part + '"  >& ' + config_file.replace(".cfg","") +
                             '_' + git_ver + '_' + time_stamp + '/' + testname + '_output_$1' + '\n' + 'sleep 10 \n')
    testscript.write('fi\n')
    # if server_count == 3:
    #     testscript.write('ssh ' + local_host + '  "' + server_kill + '"\n' +
